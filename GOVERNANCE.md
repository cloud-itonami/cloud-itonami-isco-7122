...
`cloud-itonami-isco-7122` is an OSS open-occupation blueprint. Governance covers
...
- Floor & Tile Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- a flooring/tile-installation-execution decision, and any override of a
  site safety officer's judgment, stay permanently outside this actor's
  op-allowlist.
...
- attempting to route a flooring/tile-installation-execution decision, or a
