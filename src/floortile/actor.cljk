(ns floortile.actor
  "FloorTileActor — the ISCO-08 7122 floor-laying/tile-setting job-site
  ...
  housebuilder.actor (job-site scheduling/logistics coordination
  shape) and cloud-itonami-isco-3313's accountingsupport.actor.
  ...
  The unconditional invariant: the Floor & Tile Advisor can never
  directly commit an operating record the FloorTileGovernor refuses,
  and can never make this actor finalize a flooring/tile-installation-
  execution decision (e.g. a specific flooring or tile installation
  step) or override a site safety officer's judgment — every
  ...
  never performs flooring/tile-installation work or authorizes
  flooring/tile-installation itself."
...
(defn build-graph
  "Build a compiled FloorTileActor graph. `store` implements
  `floortile.store/Store`. `advisor` implements
  `floortile.advisor/Advisor` (defaults to `mock-advisor`).
