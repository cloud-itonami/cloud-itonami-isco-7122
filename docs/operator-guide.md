...
- safety-critical escalation path (fume exposure, cut hazard, site
  condition, kneeling-strain injury)
...
- a hard, unconditional block on any attempt to route a
  flooring/tile-installation-execution decision, or a site-safety-
  officer-override decision, through this actor — those decisions
  stay the site safety officer's exclusive authority end to end
...
flooring/tile-installation-execution decision or a site-safety-officer
